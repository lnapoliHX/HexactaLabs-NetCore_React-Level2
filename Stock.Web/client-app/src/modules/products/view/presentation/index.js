  ...
  return (
	<Container fluid>
		...
		<div className="info-box">
			...
			<Row>
				<Col lg="2">Id Categoria</Col>
				<Col>{props.product.productTypeId}</Col>
			</Row>
			<Row>
				<Col lg="2">Descripción Categoria</Col>
		...
		<div className="provider-view__button-row">
			...
			color="primary"
			onClick={() =>
				props.push(`/products/update/${props.match.params.id}`)
			}
			>
			...
			color="danger"
			onClick={() =>
				props.push(`/products/view/${props.match.params.id}/remove`)
			}
			>
