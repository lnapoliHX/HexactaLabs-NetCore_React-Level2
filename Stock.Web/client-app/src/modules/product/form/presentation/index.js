...
const ProductForm = props => {
  ...
  return (
    <Form onSubmit={handleSubmit} className="addForm">
      ...
      <InputList url="/provider" name="providerId" label="Proveedor del producto" param="name"/>
      <InputList url="/producttype" name="productTypeId" label="Categoría del producto" param="description"/> 
